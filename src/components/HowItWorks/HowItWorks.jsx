            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col justify-center bg-white w-full max-w-[610px] rounded-[2rem] p-10 shadow-2xl">
                    ...
                    <div className="flex items-start mb-8">
                        <div className="flex items-center justify-center w-14 h-14 bg-yellow rounded-full text-white font-bold text-2xl shrink-0 mt-1">
                            1
                        </div>
                        <div className="ml-6 max-w-sm">
                            <p className="text-very-dark-blue leading-relaxed">
